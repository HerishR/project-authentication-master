...
app.post("/register", function(req,res) {
  Client.register({username: req.body.username,aadhar:req.body.aadhar,phoneno:req.body.phone,dl:req.body.DL,bikeid:req.body.VehicleNumber},req.body.password, function(err,user){
    if(err) {
      console.log(err);
